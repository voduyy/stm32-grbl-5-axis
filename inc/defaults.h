...
#if defined(AA_AXIS) || defined(AB_AXIS) || defined(ABC_AXIS)
#define DEFAULT_A_MAX_RATE 600.0f // A axis mm/min
#endif
#if defined(AB_AXIS) || defined(ABC_AXIS)
#define DEFAULT_B_MAX_RATE 600.0f // B axis mm/min
#endif
#if defined(ABC_AXIS)
...
#endif
#if defined(ABC_AXIS)
#define DEFAULT_C_ACCELERATION (1000.0f * 60 * 60) // C axis 10*60*60 mm/min^2 = 10 mm/sec^2
#endif
